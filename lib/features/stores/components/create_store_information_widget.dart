...
class CreateStoreInformationWidget extends StatefulWidget {
  const CreateStoreInformationWidget({
  ...
  @override
  State<CreateStoreInformationWidget> createState() =>
      _CreateStoreInformationWidgetState();
}

class _CreateStoreInformationWidgetState
    extends State<CreateStoreInformationWidget> {
  String fieldTitle = '';
