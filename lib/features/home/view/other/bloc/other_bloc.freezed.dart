...
abstract class $OtherStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {UIStatus status, LogoutResponse logoutResponse, String loginBadRequest});
...
class _$OtherStateImpl implements _OtherState {
  ...
  @override
  String toString() {
    return 'OtherState(status: $status, logoutResponse: $logoutResponse, loginBadRequest: $loginBadRequest)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, logoutResponse, loginBadRequest);
...
abstract class _OtherState implements OtherState {
  const factory _OtherState(
      {final UIStatus status,
      final LogoutResponse logoutResponse,
      final String loginBadRequest}) = _$OtherStateImpl;
