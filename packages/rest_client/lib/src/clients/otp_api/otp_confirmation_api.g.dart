...
part of 'otp_confirmation_api.dart';
...
class _OtpApiClient implements OtpApiClient {
  ...
  @override
  Future<LoginResponse> otpConfirmation(Map<String, dynamic> json) async {
  ...
  @override
  Future<ResendOTPResponse> resendOtp(Map<String, dynamic> json) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
